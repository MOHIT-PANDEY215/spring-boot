                    ...
                    <tbody>
                        <c:forEach items="${customers}" var="customer">
                            <tr>
                                ...
                                <td>${customer.city} s</td>
                                <td>${customer.state} s</td>
                                <td>${customer.email} a</td>
                                <td>${customer.phone} a</td>
                                <td>
                                    <!-- Add buttons/links for updating and deleting customers -->
                                    <a href="/dashboard/update/${customer.id}">Update</a>
                                    <a href="/dashboard/delete/${customer.id}">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                        <tr>
                            ...
                            <td>(171) 555-2222</td>
                            <td>
                                <a href="#editCustomerModal" class="edit" data-toggle="modal"><i class="material-icons"
